...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@buaa.edu.cn}{youremail@buaa.edu.com}
        \hspace{4em}
        % 手机号
        \faPhone \quad  130-6666-0000
        % 别的联系方式，如微信、GitHub等
        \hspace{4em}
        \faGithub \quad \href{https://github.com/v0yager33/buaa-CV}{GitHub 项目地址}
    }
}
...
\begin{document}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        \begin{itemize}
            ...
            \item \textbf{GPA}：4.0 / 4.0（排名：1 / 250）
        \end{itemize}
        
        \vspace{0.5em}
        {\large \textbf{北京航空航天大学}}，硕士 \hfill 2020年9月--至今
        \begin{itemize}
    ...
    \begin{minipage}[t]{\textwidth}
        ...
        \begin{itemize}
            ...
            \item \textbf{主要成果}：成功支撑双 11 期间每秒 10 万 + 的请求峰值，系统延迟降低 20\%。
            \item \textbf{技术栈}：Golang, Redis, Kubernetes, Prometheus。
        \end{itemize}
    
        \vspace{0.6em}
    
        {\large \textbf{某某科技有限公司}} \hfill 2022 年 12 月 -- 2023 年 3 月 \\
        \textit{算法实习生} \hfill 北京
        \begin{itemize}
            \item \textbf{核心工作}：参与 XX 大模型预训练数据处理，设计自动化清洗流水线。
            \item \textbf{主要成果}：清洗高质量数据超 100 万条，提升模型收敛速度 15\%。
    ...
    \begin{itemize}
        \item \textbf{Mingzi Nide}, Daoshi Nide. \hfill 发表于 \textbf{Journal B}（中科院一区, IF11.2）
        \item 用一句话描述这份论文干了什么\dots\dots
    \end{itemize}
    \end{minipage}
